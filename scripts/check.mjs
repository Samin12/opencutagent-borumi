// Syntax-check every .js/.mjs file in the plugin (scripts/, tests/, animation-kit/scripts) (recursively, skipping
...
const SKIP_DIRS = new Set(["node_modules", ".cache", "out", ".git", "public", "src", "styles"]);
