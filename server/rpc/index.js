...
const ENV_SPECS = [
  ...
  { key: "EDITAGENT_ANIM_RENDER_ATTEMPTS", def: "2", desc: "How many times to retry a whole animation render that dies on its own (a frozen browser page). 1 = never retry." },
  { key: "EDITAGENT_ANIM_CONCURRENCY", def: "", desc: "Browser pages used per animation render. Empty = automatic (fewer at 4K, where too many pages freeze the renderer)." },
